...
namespace MVC
{
    public class AppController
    {
        ...
        public String PluginPath = "E:/ООП/Laba2.v13/Source/Plugin/bin/Debug/net5.0/Plugin.dll";
...
/*                appModel.CurrentElement.BorderColor = Color.White;
                appModel.CurrentElement.Width = appModel.CurrentWidth;
                appModel.CurrentElement.FillColor = Color.White;                 
                Pen pen = new Pen(Color.White, appModel.CurrentElement.Width);
                ...
                pen.Color = appModel.CurrentDrawingColor;
...
//                    domainModel.DrawElements();
        ...
        {
            appModel.CurrentDrawingColor = color; 
        }

        public void SetFillColor(Color backgroudcolor)
        {
            if(backgroudcolor != Color.Transparent)
            {
                appModel.IsFillActive = true;
                appModel.CurrentFillColor = backgroudcolor;
            }
